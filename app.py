...
predicted_my_land_price2 = predicted_my_land_price_df*69*2.5/100000000
...
df_combined_future["difference"] = df_combined_future["predicted my_land_price"] - df_combined_future["predicted apt2_price"]
...
plt.scatter(predicted_myland_price_denorm2_df.index, predicted_myland_price_denorm2_df, label='Predicted_my_land_price', marker='x', color = "blue")
